...
define(['dojo/_base/declare', 'dojo/_base/array', 'esri/renderers/jsonUtils', 'jimu/dijit/RendererChooser', '../BaseEditor', './simpleEditors'], function (declare, array, rendererUtils, RendererChooser, BaseEditor, simpleEditors) {
  var clazz = declare([BaseEditor], {
    ...
    _getSymbolType: function _getSymbolType() {
