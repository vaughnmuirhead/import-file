...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'jimu/dijit/CheckBox', 'jimu/dijit/LoadingIndicator', 'jimu/dijit/Message', 'esri/tasks/query', 'esri/layers/GraphicsLayer', 'esri/SpatialReference', 'esri/tasks/QueryTask', 'esri/symbols/jsonUtils', 'esri/renderers/SimpleRenderer', '../BaseEditor', 'dojo/text!./SelectFeatureSetFromUrl.html', 'jimu/dijit/URLInput'], function (declare, lang, array, _TemplatedMixin, _WidgetsInTemplateMixin, CheckBox, LoadingIndicator, Message, Query, GraphicsLayer, SpatialReference, QueryTask, symbolUtils, SimpleRenderer, BaseEditor, template) {
  //from url
  var clazz = declare([BaseEditor, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    viewLayerContent: function viewLayerContent(checked) {
      if (checked) {
        ...
        this.queryTask.execute(query, lang.hitch(this, this._addToLayer), lang.hitch(this, this._queryError));
      } else {
    ...
    _queryError: function _queryError(err) {
      this._hideLoading();
      new Message({
        message: err.message
      });
    ...
    _addToLayer: function _addToLayer(featureSet) {
