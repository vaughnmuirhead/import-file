...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/on', 'dojo/Deferred', 'dojo/promise/all', 'dojo/json', 'dijit/form/NumberTextBox', 'dijit/form/Select', 'dijit/form/Textarea', 'dijit/form/DateTextBox', 'dijit/form/TimeTextBox', 'jimu/dijit/CheckBox', 'jimu/dijit/URLInput', 'jimu/dijit/DrawBox', 'jimu/utils', 'esri/tasks/LinearUnit', 'esri/tasks/FeatureSet', 'esri/geometry/Polygon', 'esri/graphic', 'esri/graphicsUtils', '../BaseEditor', '../LayerOrderUtil'], function (declare, lang, array, html, on, Deferred, all, json, NumberTextBox, Select, Textarea, DateTextBox, TimeTextBox, CheckBox, URLInput, DrawBox, utils, LinearUnit, FeatureSet, Polygon, Graphic, graphicsUtils, BaseEditor, LayerOrderUtil) {
  var mo = {};
  ...
  mo.MultiValueEditor = declare(BaseEditor, {
    ...
    _initChildEditors: function _initChildEditors(_param, inputListNode) {
    ...
    _createSingleInputContainerNode: function _createSingleInputContainerNode(param, inputListNode) {
    ...
    _createRemoveInputNode: function _createRemoveInputNode(containerNode) {
      var node = html.create('div', {
        'class': 'remove',
        innerHTML: '-'
      }, containerNode);
    ...
    _createAddInputNode: function _createAddInputNode(param, inputListNode) {
      var node = html.create('div', {
        'class': 'add-input'
      }, this.domNode);
  ...
  mo.LinerUnitEditor = declare(BaseEditor, {
    ...
    postCreate: function postCreate() {
      ...
      this.selectDijit = new Select({
        value: this.units,
        options: [{ label: this.nls.Meter, value: 'esriMeters' }, { label: this.nls.Kilometers, value: 'esriKilometers' }, { label: this.nls.Feet, value: 'esriFeet' }, { label: this.nls.Miles, value: 'esriMiles' }, { label: this.nls.NauticalMiles, value: 'esriNauticalMiles' }, { label: this.nls.Yards, value: 'esriYards' }]
      });
  ...
  mo.DateTimeEditor = declare(BaseEditor, {
    ...
    postCreate: function postCreate() {
      ...
      this.value = this.param.defaultValue ? new Date(defaultDt.getFullYear(), defaultDt.getMonth(), defaultDt.getDate(), defaultDt.getHours(), defaultDt.getMinutes(), defaultDt.getSeconds()) : null;
      this.inherited(arguments);
  ...
  mo.SelectFeatureSetFromDraw = declare([BaseEditor, DrawBox], {
    ...
    postCreate: function postCreate() {
      ...
      try {
        ...
        layerOrderUtil.calculateLayerIndex(this.paramName, this.widgetUID).then(lang.hitch(this, function (layerIndex) {
          if (layerIndex !== -1) {
    ...
    _createFeatureSet: function _createFeatureSet(graphics) {
