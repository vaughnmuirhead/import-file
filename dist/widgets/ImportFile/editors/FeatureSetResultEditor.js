...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/text!./FeatureSetResultEditor.html', 'dijit/_TemplatedMixin', '../BaseEditor', './FeatureSetRendererEditor', 'jimu/dijit/PopupConfig', 'jimu/dijit/TabContainer', 'jimu/dijit/CheckBox'], function (declare, lang, array, template, _TemplatedMixin, BaseEditor, FeatureSetRendererEditor, PopupConfig, TabContainer, CheckBox) {
  var clazz = declare([BaseEditor, _TemplatedMixin], {
    ...
    postCreate: function postCreate() {
      ...
      var tabs = [{ title: this.nls.renderer, content: this.rendererTab }, { title: this.nls.popup, content: this.popupConfigTab }];
