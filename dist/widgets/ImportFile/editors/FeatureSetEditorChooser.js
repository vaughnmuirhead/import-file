...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dojo/text!./FeatureSetEditorChooser.html', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'jimu/dijit/SymbolChooser', 'jimu/dijit/CheckBox', 'jimu/utils', 'esri/symbols/jsonUtils', '../BaseEditor', 'dijit/form/RadioButton'], function (declare, lang, html, on, template, _TemplatedMixin, _WidgetsInTemplateMixin, SymbolChooser, CheckBox, utils, jsonUtils, BaseEditor) {
  return declare([BaseEditor, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _onLayersModeSelect: function _onLayersModeSelect() {
      html.setStyle(this.symbolChooserSection, 'display', 'none');
      html.setStyle(this.urlOptionsDiv, 'display', 'none');
    ...
    _viewLayerContent: function _viewLayerContent(checked) {
      if (checked) {
        this._showSymbolChooser();
      } else {
        html.setStyle(this.symbolChooserSection, 'display', 'none');
