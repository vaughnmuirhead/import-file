...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/dom-style', 'dojo/dom-attr', 'dojo/on', 'dojo/Deferred', 'dojo/text!./DataFileEditor.html', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'esri/tasks/DataFile', 'esri/request', 'jimu/dijit/ViewStack', 'jimu/dijit/Message', '../BaseEditor', 'dijit/form/Form', 'jimu/dijit/URLInput'], function (declare, lang, domStyle, domAttr, on, Deferred, template, _TemplatedMixin, _WidgetsInTemplateMixin, DataFile, esriRequest, ViewStack, Message, BaseEditor) {
