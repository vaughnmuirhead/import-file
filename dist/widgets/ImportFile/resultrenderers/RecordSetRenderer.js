define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/dom-style', 'dojo/on', 'dijit/_TemplatedMixin', 'dojo/store/Memory', 'dgrid/OnDemandGrid', 'dgrid/extensions/ColumnResizer', 'jimu/exportUtils', 'jimu/dijit/ExportChooser', 'jimu/LayerInfos/LayerInfos', 'dojo/text!./RecordSetRenderer.html', '../BaseResultRenderer'], function (declare, lang, array, html, domStyle, on, _TemplatedMixin, Memory, OnDemandGrid, ColumnResizer, exportUtils, ExportChooser, LayerInfos, template, BaseResultRenderer) {
  return declare([BaseResultRenderer, _TemplatedMixin], {
    ...
    postCreate: function postCreate() {
      ...
      var fields = [];
      if (this.param.defaultValue && this.param.defaultValue.output && this.param.defaultValue.output.fields) {
