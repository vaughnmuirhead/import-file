...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dojo/text!./ParamSetting.html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'jimu/dijit/Popup', 'jimu/utils', '../editorManager', '../EditorChooser', 'dijit/form/TextBox', 'jimu/dijit/CheckBox'], function (declare, lang, html, on, template, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Popup, utils, editorManager, EditorChooser) {
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    setParam: function setParam(param, direction) {
      this.param = param;
    ...
    _createSpecialPart: function _createSpecialPart() {
      var label;
      ...
      if (this.config.useResultMapServer && this.direction === 'output' && (this.param.dataType === 'GPFeatureRecordSetLayer' || this.param.dataType === 'GPRasterDataLayer')) {
    ...
    _createChangeEditorNode: function _createChangeEditorNode() {
    ...
    _onEditorChange: function _onEditorChange(editorChooser) {
