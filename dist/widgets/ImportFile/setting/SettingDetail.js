...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/array', 'dojo/on', 'dojo/query', 'dojo/text!./SettingDetail.html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/TitlePane', 'jimu/dijit/ViewStack', 'jimu/dijit/LoadingShelter', 'jimu/dijit/Message', './ParamSetting', './ParamNodeList', './LayerOrder', './Options', '../utils'], function (declare, lang, html, array, on, query, template, _WidgetBase, _TemplatedMixin, TitlePane, ViewStack, LoadingShelter, Message, ParamSetting, ParamNodeList, LayerOrder, Options, gputils) {
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    _changeTaskInfoToConfig: function _changeTaskInfoToConfig(taskInfo) {
    ...
    _initNavPane: function _initNavPane() {
    ...
    _onParamChange: function _onParamChange(param, direction) {
    ...
    _setActiveLinkNode: function _setActiveLinkNode(node) {
      query('.jimu-state-active', this.domNode).removeClass('jimu-state-active');
      this._clearParamSelection();
      html.addClass(node, 'jimu-state-active');
    },

    _createParamsSection: function _createParamsSection(direction) {
    ...
    _createLayerOrderNode: function _createLayerOrderNode() {
    ...
    _createOptionsNode: function _createOptionsNode() {
      var node = html.create('div', {
    ...
    _clearParamSelection: function _clearParamSelection(direction) {
