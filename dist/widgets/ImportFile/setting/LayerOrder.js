...
define(['dojo/_base/declare', 'dojo/_base/array', 'dijit/_WidgetBase', 'jimu/dijit/SimpleTable', '../LayerOrderUtil'], function (declare, array, _WidgetBase, SimpleTable, LayerOrderUtil) {
  return declare([_WidgetBase], {
    ...
    _initLayerTable: function _initLayerTable() {
      var layerOrder = [];
