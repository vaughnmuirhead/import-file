...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/string', 'dojo/aspect', 'dojo/on', 'dojo/dom-class', 'dojo/dom', 'dojo/Evented', 'dojo/dnd/Source', 'dojo/dom-construct', 'dijit/_WidgetBase', 'dojo/text!./ParamNode.html', 'dojo/text!./ParamNodeAvatar.html'], function (declare, lang, stringUtil, aspect, on, domClass, dom, Evented, Source, domConstruct, _WidgetBase, template, avatarTemplate) {
  return declare([_WidgetBase, Evented], {
    ...
    _paramNodeCreator: function _paramNodeCreator(param, hint) {
      var node;
    ...
    handleDrop: function handleDrop(source, nodes) {
      /*jshint unused: false*/
