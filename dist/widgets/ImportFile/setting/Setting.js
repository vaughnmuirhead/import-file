...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/GpSource', 'jimu/dijit/ViewStack', 'jimu/dijit/Popup', './SettingDetail', 'dijit/form/ValidationTextBox'], function (declare, lang, html, on, _WidgetsInTemplateMixin, BaseWidgetSetting, GpSource, ViewStack, Popup, SettingDetail) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _onChooseTaskClicked: function _onChooseTaskClicked() {
      var args = {
    ...
    _onServiceSelected: function _onServiceSelected(service) {
