...
define(['dojo/_base/declare', 'dojo/Deferred', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin'], function (declare, Deferred, _WidgetBase) {
  //summary:
  ...
  var clazz = declare([_WidgetBase], {
    ...
    wrapGPValue: function wrapGPValue(value) {
      if (!value) {
        return value;
      }
      if (!value.toJson) {
    ...
    wrapValueToDeferred: function wrapValueToDeferred(value) {
      var def = new Deferred();
      def.resolve(value);
      return def;
    },

    update: function update( /*jshint unused: false*/dependParamValue) {}
  });
  return clazz;
});
