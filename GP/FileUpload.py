...
def ImportDXF(DXFFile, DXFSpatialReference):
    ...
    arcpy.CADToGeodatabase_conversion(DXFFile, arcpy.env.scratchGDB, os.path.basename(output_dataset), DXFSpatialReference.scaleFactor, DXFSpatialReference)
...
try:
    uploadedExt = os.path.basename(InputFile).split('.')[-1].lower() #extension of uploaded file. remove "." and make string lowercase
    ...
    if uploadedExt == "zip":
        ...
        for File in FileList:
            ...
            if FileExtension == "dxf":
                ...
                Results = ImportShapeFile(File, InputSpatialReference)
                break
